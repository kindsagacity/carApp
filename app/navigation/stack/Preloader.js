    ...
    return (
      <Swiper
        ...
        <View style={styles.slide}>
          <CardSection style={styles.preloaderBlock}>
            <CardSection style={styles.preloaderBlock__forImage}>
              <Image source={backgrounds['preview-1']} style={styles.preloaderBlock__img} />
            </CardSection>
        ...
        <View style={styles.slide}>
          <CardSection style={styles.preloaderBlock}>
            <CardSection style={styles.preloaderBlock__forImage}>
              <Image source={backgrounds['preview-2']} style={styles.preloaderBlock__img} />
            </CardSection>
            <CardSection style={styles.preloaderForHeader}>
        ...
        <View style={styles.slide}>
          <CardSection style={styles.preloaderBlock}>
            <CardSection style={styles.preloaderBlock__forImage}>
              <Image source={backgrounds['preview-3']} style={styles.preloaderBlock__img} />
            </CardSection>
            <CardSection style={styles.preloaderForHeader}>
        ...
        <View style={styles.slide}>
          <CardSection style={styles.preloaderBlock}>
            <CardSection style={styles.preloaderBlock__forImage}>
              <Image source={backgrounds['preview-4']} style={styles.preloaderBlock__img} />
            </CardSection>
            <CardSection style={styles.preloaderForHeader}>
