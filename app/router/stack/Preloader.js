...
class Preloader extends Component {
  ...
  render() {
    //this.setState({auto1:true});
    return (

      <View style={{height:'100%',backgroundColor: '#fef4f4'}}>
        <Swiper autoplay={this.state.auto1} autoplayDelay={this.state.dil} autoplayLoop={true}
                onStartShouldSetResponder={(event) => true}
                onResponderStart={()=>{this.setState({auto1:false})}}
                onResponderEnd={(index)=>{index=0;this.setState({auto1:true}); }}



                style={{flex: 1, borderWidth: 1, borderColor: '#000',backgroundColor:'transparent'}}
                paginationStyle={{ position: 'absolute', top: -460 }}
          ...
          <View style={styles.slide}>
            <CardSection style={styles.preloaderBlock}>
              <CardSection style={styles.preloaderBlock__forImage}>
                <Image resizeMode="contain" source={require("../../files/images/preview1.png")} style={styles.preloaderBlock__img}></Image>
              </CardSection>
          ...
          <View style={styles.slide}>
            <CardSection style={styles.preloaderBlock}>
              <CardSection style={styles.preloaderBlock__forImage}>
                <Image resizeMode="contain" source={require("../../files/images/preview2.png")} style={styles.preloaderBlock__img}></Image>
              </CardSection>
              <CardSection style={styles.preloaderForHeader}>
          ...
          <View style={styles.slide}>
            <CardSection style={styles.preloaderBlock}>
              <CardSection style={styles.preloaderBlock__forImage}>
                <Image resizeMode="contain" source={require("../../files/images/preview3.png")} style={styles.preloaderBlock__img}></Image>
              </CardSection>
              <CardSection style={styles.preloaderForHeader}>
          ...
          <View style={styles.slide}>
            <CardSection style={styles.preloaderBlock}>
              <CardSection style={styles.preloaderBlock__forImage}>
                <Image resizeMode="contain" source={require("../../files/images/preview4.png")} style={styles.preloaderBlock__img}></Image>
              </CardSection>
              <CardSection style={styles.preloaderForHeader}>
